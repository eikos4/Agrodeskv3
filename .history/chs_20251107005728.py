...
with app.app_context():
    EMPRESA_SLUG   = "consultora-chs"     # slug (minúsculas/sin espacios)
    EMPRESA_NOMBRE = "CONSULTORA CHS"     # nombre visible

    ADMIN_EMAIL  = "g.castilla@agrodesk.cl"
    ADMIN_PASS   = "adminguido"
    ADMIN_NOMBRE = "Guido Castilla Mora"
