...
class User(db.Model):
    ...
    # Este campo se utilizará para hacer referencia al administrador que creó el perfil
    created_by = db.Column(db.Integer, db.ForeignKey('users.id'), nullable=True)

    # Relación recursiva (un administrador puede crear muchos técnicos)
...
class Bodega(db.Model):
    ...
    responsable = db.relationship('User', backref='bodegas', lazy=True)  # El backref 'bodegas' va aquí
