...
class User(db.Model, UserMixin):
    __tablename__ = 'users'  # Plural 'users'
    ...
    # Relación con bodegas usando back_populates para evitar conflicto de backrefs
...
class Bodega(db.Model):
    ...
    # Usamos back_populates para definir la relación de forma simétrica sin crear atributos duplicados
    ...
    huerto = db.relationship('Huerto', backref='bodegas')  # Puedes conservar este backref aquí
