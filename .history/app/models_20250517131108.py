...
# -------------------------------
# OTROS MODELOS (Recomendacion, FormularioTarea, ChecklistItem)...
# (Puedes mantenerlos como los tienes, solo asegurándote que los ForeignKey referencian __tablename__)
