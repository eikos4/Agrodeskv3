...
def crear_tecnico():
    ...
    if form.validate_on_submit():
        try:
            ...
            db.session.rollback()
            flash("Error creando técnico: " + str(e), "danger")
...
def recomendar():
    ...
    if form.validate_on_submit():
        try:
            ...
            db.session.rollback()
            flash("Error asignando recomendación: " + str(e), "danger")
...
def crear_huerto():
    ...
    if form.validate_on_submit():
        try:
            ...
            db.session.rollback()
            flash("Error creando huerto: " + str(e), "danger")
...
def crear_bodega():
    ...
    if form.validate_on_submit():
        try:
            ...
            db.session.rollback()
            flash("Error creando bodega: " + str(e), "danger")
...
def editar_quimico(quimico_id):
    ...
    if request.method == 'POST':
        try:
            ...
            db.session.rollback()
            flash("Error actualizando químico: " + str(e), "danger")
