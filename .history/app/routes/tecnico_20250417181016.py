...
def tecnico_puede_acceder_a_bodega(bodega):
    return bodega in current_user.bodegas
...
def ver_quimicos(bodega_id):
    ...
    if bodega not in current_user.bodegas:
        print("Bodega no asignada al usuario. Redirigiendo...")
    ...
    flash("✅ Accediste a los químicos de la bodega", "success")
