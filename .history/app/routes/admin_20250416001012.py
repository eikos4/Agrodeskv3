...
def admin_dashboard():
    ...
    bodegas = Bodega.query.all()  # Trae todas las bodegas
    print("Bodegas encontradas (admin):", len(bodegas))  # Log para depurar
...
def actualizar_recomendacion(recomendacion_id):
    ...
    bodegas = Bodega.query.all()  # ¿Retorna realmente datos?
    print("BODEGAS EN ADMIN:", bodegas)  # Depuración
    # ...
