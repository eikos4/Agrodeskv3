...
class ActividadHuerto(db.Model):
    ...
    anio = db.Column(db.Integer)          # Año de la actividad, opcional

    huerto = db.relationship('Huerto', backref='actividades')
