...
with app.app_context():
    EMPRESA_SLUG   = "agro-parral"     # slug (minúsculas/sin espacios)
    EMPRESA_NOMBRE = "AgroParral"     # nombre visible

    ADMIN_EMAIL  = "paloma@agrodesk.cl"
    ADMIN_PASS   = "Paloma123"
    ADMIN_NOMBRE = "Paloma García"
